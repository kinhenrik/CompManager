...
//
//        List<Matches> matchList = MatchesDAO.getAllMatches();
//
//        // Omvandla lista till ObservableList för JavaFX
//        ObservableList<Matches> observableMatchList = FXCollections.observableArrayList(matchList);
//
//
//        // Skapa TableView
...
//        team1Column.setCellValueFactory(new PropertyValueFactory<>(getValue().getTeam1().getName()));
//
//        TableColumn<Matches, String> team2Column = new TableColumn<>("Team 2");
//        team2Column.setCellValueFactory(new PropertyValueFactory<>(getValue().getTeam2().getName()));
//
//        // Kolumn för Winner
//        TableColumn<Matches, String> winnerColumn = new TableColumn<>("Winner");
//        winnerColumn.setCellValueFactory(new PropertyValueFactory<>(.getValue().getWinner().getName()));
//
//        // Lägg till kolumner i tabellen
//        table.getColumns().addAll(idColumn, dateColumn, typeColumn, team1Column, team2Column, winnerColumn);
//
//
